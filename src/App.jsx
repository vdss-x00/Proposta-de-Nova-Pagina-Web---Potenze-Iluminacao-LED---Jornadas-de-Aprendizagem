  ...
  return (
    <div className="min-h-screen bg-zinc-100 font-sans text-zinc-900 dark:bg-[#303030]">
      ...
      <main>
        ...
        <section className="bg-zinc-200 text-white py-24 px-6 dark:bg-black/50 dark:text-zinc-300">
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <img
                src={highBayModular}
                alt="Potenze LED"
                className="rounded-3xl shadow-2xl object-cover w-full h-full bg-transparent"
              />
            </div>
          </div>
        </section>
